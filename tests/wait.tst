...
msglvl -debug +verbose +emsgloc

* ----------------------------------------------------------------------------
*
*Testcase Script 'wait' statement test
*
* ----------------------------------------------------------------------------
*
...
defsym  secs3     4
*
defsym  wait     10.0   #  How long to 'wait' for test to finish
*
* ----------------------------------------------------------------------------
*
...
* ----------------------------------------------------------------------------
*
restart                 # Get the ball rolling...
*
wait  $(wait)           # Wait for CPUs to enter disabled wait
*
* ----------------------------------------------------------------------------
*
