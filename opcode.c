...
zz_func opcode_b3xx[256][GEN_MAXARCH] = {
 ...
 /*B339*/ GENx___x___x900 (multiply_unnormal_float_long_to_ext_low_reg,RRE,"MYLR"),         /*@Z9*/
 /*B33A*/ GENx___x___x900 (multiply_add_unnormal_float_long_to_ext_reg,RRF_R,"MAYR"),       /*@Z9*/
 /*B33B*/ GENx___x___x900 (multiply_unnormal_float_long_to_ext_reg,RRE,"MYR"),              /*@Z9*/
 /*B33C*/ GENx___x___x900 (multiply_add_unnormal_float_long_to_ext_high_reg,RRF_R,"MAYHR"), /*@Z9*/
 /*B33D*/ GENx___x___x900 (multiply_unnormal_float_long_to_ext_high_reg,RRE,"MYHR"),        /*@Z9*/
...
zz_func opcode_edxx[256][GEN_MAXARCH] = {
 ...
 /*ED39*/ GENx___x___x900 (multiply_unnormal_float_long_to_ext_low,RXE,"MYL"),       /*@Z9*/
 /*ED3A*/ GENx___x___x900 (multiply_add_unnormal_float_long_to_ext,RXF,"MAY"),       /*@Z9*/
 /*ED3B*/ GENx___x___x900 (multiply_unnormal_float_long_to_ext,RXE,"MY"),            /*@Z9*/
 /*ED3C*/ GENx___x___x900 (multiply_add_unnormal_float_long_to_ext_high,RXF,"MAYH"), /*@Z9*/
 /*ED3D*/ GENx___x___x900 (multiply_unnormal_float_long_to_ext_high,RXE,"MYH"),      /*@Z9*/
