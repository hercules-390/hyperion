...
DLL_EXPORT zz_func opcode_table[256][GEN_MAXARCH] = {
 ...
 /*20*/   GENx370x390x900 (load_positive_float_long_reg,RRE,"LPDR"),
 /*21*/   GENx370x390x900 (load_negative_float_long_reg,RRE,"LNDR"),
 /*22*/   GENx370x390x900 (load_and_test_float_long_reg,RRE,"LTDR"),
 /*23*/   GENx370x390x900 (load_complement_float_long_reg,RRE,"LCDR"),
