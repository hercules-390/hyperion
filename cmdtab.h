...
COMMAND("cp_updt",   PANEL+CONFIG,   SYSCMDALL,          cp_updt_cmd,
  "Create/Modify user character conversion table",
    ...
    "\n"
    "  altER e|a|g2h|h2g (pos,val,pos,val...) - alter the user eBCDIC or\n" 
    "                                aSCII table value at hex POSition to\n"
    "                                hex VALue 16 pairs of hex digits\n"
    "                                may be specified within the parens.\n"
    "\n"
