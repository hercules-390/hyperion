...
/* awstape.c */
#define HHCTA101I "Device(%d:%4.4X): AWS Tape file(%s) closed"
#define HHCTA102E "Device(%d:%4.4X): Error opening file(%s): (%s)"
#define HHCTA103E "Device(%d:%4.4X): Error seeking to offset("I64_FMTX") in file(%s): (%s)"
#define HHCTA104E "Device(%d:%4.4X): Error reading block header at offset("I64_FMTX") in file(%s): (%s)"
#define HHCTA105E "Device(%d:%4.4X): End of file (end of tape) at offset("I64_FMTX") in file(%s)"
#define HHCTA106E "Device(%d:%4.4X): Unexpected end of file in block header at offset("I64_FMTX") in file(%s)"
#define HHCTA107E "Device(%d:%4.4X): Block length(%d) exceeds at offset("I64_FMTX") in file(%s)"
#define HHCTA108E "Device(%d:%4.4X): Invalid tapemark at offset("I64_FMTX") in file(%s)"
#define HHCTA109E "Device(%d:%4.4X): Error reading data block at offset("I64_FMTX") in file(%s): (%s)"
#define HHCTA110E "Device(%d:%4.4X): Unexpected end of file in data block at offset("I64_FMTX") in file(%s)"
#define HHCTA111E "Device(%d:%4.4X): Error seeking to offset("I64_FMTX") in file(%s): (%s)"
#define HHCTA112E "Device(%d:%4.4X): Media full condition reached at offset("I64_FMTX") in file(%s)"
#define HHCTA113E "Device(%d:%4.4X): Error writing block header at offset("I64_FMTX") in file(%s): (%s)"
#define HHCTA114E "Device(%d:%4.4X): Media full condition reached at offset("I64_FMTX") in file(%s)"
#define HHCTA115E "Device(%d:%4.4X): Error writing data block at offset("I64_FMTX") in file(%s): (%s)"
#define HHCTA116E "Device(%d:%4.4X): Error writing data block at offset("I64_FMTX") in file(%s): (%s)"
#define HHCTA117E "Device(%d:%4.4X): Error seeking to offset("I64_FMTX") in file(%s): (%s)"
#define HHCTA118E "Device(%d:%4.4X): Error writing block header at offset("I64_FMTX") in file (%s): (%s)"
#define HHCTA119E "Device(%d:%4.4X): Error writing tape mark at offset("I64_FMTX") in file(%s): (%s)"
#define HHCTA120E "Device(%d:%4.4X): Sync error on file(%s): (%s)"
...
/* faketape.c */
#define HHCTA501I "Device(%d:%4.4X) FakeTape(%s) closed"
#define HHCTA502E "Device(%d:%4.4X) Error opening file(%s) %s"
#define HHCTA503E "Device(%d:%4.4X) Error seeking to offset("I64_FMTX")in file(%s) %s"
#define HHCTA504E "Device(%d:%4.4X) Error reading block header at offset("I64_FMTX") in file(%s) %s"
#define HHCTA505E "Device(%d:%4.4X) End of file (end of tape) at offset("I64_FMTX") in file(%s)"
#define HHCTA506E "Device(%d:%4.4X) Unexpected end of file in block header at offset("I64_FMTX") in file(%s)"
#define HHCTA507E "Device(%d:%4.4X) Block header damage at offset("I64_FMTX") in file(%s)"
#define HHCTA508E "Device(%d:%4.4X) Block length exceeds %d at offset("I64_FMTX") in file (%s)"
#define HHCTA510E "Device(%d:%4.4X) Error reading data block at offset("I64_FMTX") in file(%s) %s"
#define HHCTA511E "Device(%d:%4.4X) Unexpected end of file in data block at offset("I64_FMTX") in file(%s)"
#define HHCTA512E "Device(%d:%4.4X) Error seeking to offset("I64_FMTX") in file(%s) %s"
#define HHCTA513E "Device(%d:%4.4X) Media full condition reached at offset("I64_FMTX") in file(%s)"
#define HHCTA514E "Device(%d:%4.4X) Error writing block header at offset("I64_FMTX") in file(%s) %s"
#define HHCTA515E "Device(%d:%4.4X) Error seeking to offset("I64_FMTX") in file(%s) %s"
#define HHCTA517E "Device(%d:%4.4X) Error writing data block at offset("I64_FMTX") in file(%s) %s"
#define HHCTA520E "Device(%d:%4.4X) Error writing tape mark at offset("I64_FMTX") in file(%s) %s"
#define HHCTA521E "Device(%d:%4.4X) Sync error on file(%s) %s"
...
/* hettape.c */
#define HHCTA401E "Device(%d:%4.4X) Error opening file(%s) %s(%s)"
#define HHCTA402E "Device(%d:%4.4X) Error seeking to start of file(%s) %s(%s)"
#define HHCTA414E "Device(%d:%4.4X) End of file (end of tape) at block("I32_FMTX") in file(%s)"
#define HHCTA415E "Device(%d:%4.4X) Error reading data block at block("I32_FMTX") in file(%s) %s(%s)"
#define HHCTA416E "Device(%d:%4.4X) Error writing data block at block("I32_FMTX") in file(%s) %s(%s)"
#define HHCTA417E "Device(%d:%4.4X) Error writing tape mark at block("I32_FMTX") in file(%s) %s(%s)"
#define HHCTA418E "Device(%d:%4.4X) Error forward spacing at block("I32_FMTX") in file(%s) %s(%s)"
#define HHCTA420E "Device(%d:%4.4X) Error forward spacing to next file at block("I32_FMTX") in file(%s) %s(%s)"
#define HHCTA421E "Device(%d:%4.4X) Error back spacing to previous file at block("I32_FMTX") in file(%s) %s(%s)"
#define HHCTA430I "Device(%d:%4.4X) Maximum tape capacity exceeded"
#define HHCTA431I "Device(%d:%4.4X) Maximum tape capacity enforced"
#define HHCTA488E "Device(%d:%4.4X) Sync error on file(%s) %s"
...
/* omatape.c */
#define HHCTA232I "Device(%d:%4.4X) Invalid filename %s: TDF files must be in the TAPES subdirectory"
#define HHCTA239E "Device(%d:%4.4X) Error opening TDF file(%s) %s"
#define HHCTA240E "Device(%d:%4.4X) File(%s) fstat error %s"
#define HHCTA241E "Device(%d:%4.4X) Cannot obtain buffer for TDF file(%s) %s"
#define HHCTA242E "Device(%d:%4.4X) Error reading TDF file(%s) %s"
#define HHCTA243E "Device(%d:%4.4X) File(%s) is not a valid TDF file"
#define HHCTA244E "Device(%d:%4.4X) Cannot obtain buffer for TDF array %s"
#define HHCTA245E "Device(%d:%4.4X) Filename or format missing in line(%d) of file(%s)"
#define HHCTA246E "Device(%d:%4.4X) Filename(%s) too long in line(%d) of file(%s)"
#define HHCTA247E "Device(%d:%4.4X) RECSIZE keyword missing in line(%d) of file(%s)"
#define HHCTA248E "Device(%d:%4.4X) Invalid record size(%s) in line(%d) of file(%s)"
#define HHCTA249E "Device(%d:%4.4X) Invalid record format(%s) in line(%d) of file(%s)"
#define HHCTA250E "Device(%d:%4.4X) Attempt to access beyond end of tape %s"
#define HHCTA251E "Device(%d:%4.4X) Error opening file(%s) %s"
#define HHCTA252E "Device(%d:%4.4X) Error seeking to offset("I32_FMTX") in file(%s) %s"
#define HHCTA253E "Device(%d:%4.4X) Error reading block header at offset("I32_FMTX") in file(%s) %s"
#define HHCTA254E "Device(%d:%4.4X) Unexpected end of file in block header at offset("I32_FMTX") in file(%s)"
#define HHCTA255E "Device(%d:%4.4X) Invalid block header at offset("I32_FMTX") in file(%s)"
#define HHCTA256E "Device(%d:%4.4X) Error reading data block at offset("I32_FMTX") in file(%s) %s"
#define HHCTA257E "Device(%d:%4.4X) Unexpected end of file in data block at offset("I32_FMTX") in file(%s)"
#define HHCTA263E "Device(%d:%4.4X) Invalid zero length block at offset("I32_FMTX") in file(%s)"
#define HHCTA264E "Device(%d:%4.4X) Error seeking to end of file(%s) %s"
...
/* tapedev.c */
#define HHCTA001E "Device(%d:%4.4X) Unable to determine tape format type for file(%s) Internal error: %s error(%s) on index(%d)"
#define HHCTA003W "Device(%d:%4.4X) Unable to determine tape format type for file(%s); presuming %s"
#define HHCTA004I "Device(%d:%4.4X) File(%s) is a %s"
