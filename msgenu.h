...
/* ctc_lcs.c */
#define HHCLC001E "%1d:%04X Unable to allocate LCSBLK"
#define HHCLC002I "%1d:%04X Halt or Clear Recognized"
#define HHCLC003I "%1d:%04X LCS Read"
#define HHCLC004I "%1d:%04X Sending packet to file(%s)"
#define HHCLC005E "%1d:%04X Error writing to file(%s) %s"
#define HHCLC006I "%1d:%04X Triggering Event"
...
#define HHCLC010I "Port(%2.2X) IPv4 frame for %s"
#define HHCLC011I "Port(%2.2X) ARP frame for %s"
...
#define HHCLC016I "Port(%2.2X) Enqueing frame to device %4.4X (%s)"
#define HHCLC017E "%1d:%04X invalid device name(%s)"
#define HHCLC018E "%1d:%04X invalid MAC address(%s)"
#define HHCLC019E "%1d:%04X too many arguments in statement"
#define HHCLC020E "%1d:%04X invalid IP address(%s)"
...
#define HHCLC040E "%1d:%04X LCSDEV(%4.4X) not in configuration"
#define HHCLC041W "Port(%2.2X) Frame too big; discarded"
#define HHCLC042E "Port(%2.2X) Read error: %s"
#define HHCLC043I "%1d:%04X Startup"
#define HHCLC044I "%1d:%04X Shutdown"
#define HHCLC045I "%1d:%04X Start LAN"
#define HHCLC046I "%1d:%04X Stop LAN"
#define HHCLC047I "%1d:%04X Query IP Assists"
#define HHCLC048I "%1d:%04X Statistics"
#define HHCLC049W "%1d:%04X LCS_Startup: Requested frame buffer size of 0x%4.4X larger than compiled size of 0x%4.4X; requested size ignored"
#define HHCLC050E "%1d:%04X LCS_Write: Unsupported frame type(0x%2.2X)"
#define HHCLC051I "%1d:%04X Cmd Packet"
#define HHCLC052E "%1d:%04X Invalid kernel buffer size(%s)"
#define HHCLC053E "%1d:%04X Invalid DLL I/O buffer size(%s)"
#define HHCLC054W "%1d:%04X LCS_Startup: Requested frame buffer size of 0x%4.4X smaller than compiled minimum size of 0x%4.4X; requested size ignored"
