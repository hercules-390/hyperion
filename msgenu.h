...
#define HHC00400 "%1d:%04X: File name missing or invalid filename length"
#define HHC00401 "%1d:%04X File '%s': open error: not found"
#define HHC00402 "%1d:%04X: Parameter '%s' in argument %d is invalid"
#define HHC00403 "%1d:%04X File '%s': opening as r/o%s"
#define HHC00404 "%1d:%04X File '%s': error in function '%s': %s'"
#define HHC00405 "%1d:%04X File '%s': only one base file is allowed"
#define HHC00406 "%1d:%04X File '%s': ckd header invalid"
#define HHC00407 "%1d:%04X File '%s': only 1 CCKD file allowed"
#define HHC00408 "%1d:%04X File '%s': ckd file out of sequence"
#define HHC00409 "%1d:%04X File '%s': seq %d cyls %d-%d"
#define HHC00410 "%1d:%04X File '%s': found heads %d trklen %d, expected heads %d trklen %d"
#define HHC00411 "%1d:%04X File '%s': ckd header inconsistent with file size"
#define HHC00412 "%1d:%04X File '%s': ckd header high cylinder incorrect"
#define HHC00413 "%1d:%04X File '%s': maximum CKD files exceeded: %d"
#define HHC00414 "%1d:%04X File '%s': cyls %d heads %d tracks %d trklen %d"
#define HHC00415 "%1d:%04X File '%s': device type %4.4X not found in dasd table"
#define HHC00416 "%1d:%04X File '%s': control unit '%s' not found in dasd table"
#define HHC00417 "%1d:%04X File '%s': cache hits %d, misses %d, waits %d"
#define HHC00418 "%1d:%04X File '%s': invalid track header for cyl %d head %d %02X%02X%02X%02X%%02X"
#define HHC00419 "%1d:%04X File '%s': error attempting to read past end of track '%d %d'"
#define HHC00420 "%1d:%04X File '%s': error write kd orientation"
#define HHC00421 "%1d:%04X File '%s': error write data orientation"
#define HHC00422 "%1d:%04X File '%s': data chaining not supported for CCW %02X"
#define HHC00423 "%1d:%04X File '%s': search key '%s'"
#define HHC00424 "%1d:%04X File '%s': read trk %d cur trk %d"
#define HHC00425 "%1d:%04X File '%s': read track updating track %d"
#define HHC00426 "%1d:%04X File '%s': read trk %d cache hit, using cache[%d]"
#define HHC00427 "%1d:%04X File '%s': read trk %d no available cache entry, waiting"
#define HHC00428 "%1d:%04X File '%s': read trk %d cache miss, using cache[%d]"
#define HHC00429 "%1d:%04X File '%s': read trk %d reading file %d offset %" I64_FMT "d len %d"
#define HHC00430 "%1d:%04X File '%s': read trk %d trkhdr %02X %02X%02X %02X%02X"
#define HHC00431 "%1d:%04X File '%s': seeking to cyl %d head %d"
#define HHC00432 "%1d:%04X File '%s': error: MT advance: locate record %d file mask %02X"
#define HHC00433 "%1d:%04X File '%s': MT advance to cyl(%d) head(%d)"
#define HHC00434 "%1d:%04X File '%s': read count orientation '%s'"
#define HHC00435 "%1d:%04X File '%s': cyl %d head %d record %d kl %d dl %d of %d"
#define HHC00436 "%1d:%04X File '%s': read key %d bytes"
#define HHC00437 "%1d:%04X File '%s': read data %d bytes"
#define HHC00438 "%1d:%04X File '%s': writing cyl %d head %d record %d kl %d dl %d"
#define HHC00439 "%1d:%04X File '%s': setting track overflow flag for cyl %d head %d record %d"
#define HHC00440 "%1d:%04X File '%s': updating cyl %d head %d record %d kl %d dl %d"
#define HHC00441 "%1d:%04X File '%s': ipdating cyl %d head %d record %d dl %d"
#define HHC00442 "%1d:%04X File '%s': set file mask %02X"
