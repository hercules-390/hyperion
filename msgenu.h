...
#define HHC00301 "%1d:%04X File[%d] '%s': error in function '%s': '%s'"
#define HHC00302 "%1d:%04X File[%d] '%s': error in function '%s' at offset "I64_FMTX": '%s'"
#define HHC00303 "%1d:%04X Error in function '%s': '%s'"
#define HHC00304 "%1d:%04X File[%d] '%s': get space error, size exceeds %lldM"
#define HHC00305 "%1d:%04X File[%d] '%s': device header id error"
#define HHC00306 "%1d:%04X File[%d] '%s': trklen error for %2.2x%2.2x%2.2x%2.2x%2.2x"
#define HHC00307 "%1d:%04X File[%d] '%s': invalid byte 0 trk %d, buf %2.2x%2.2x%2.2x%2.2x%2.2x"
#define HHC00308 "%1d:%04X File[%d] '%s': invalid byte 0 blkgrp %d, buf %2.2x%2.2x%2.2x%2.2x%2.2x"
#define HHC00309 "%1d:%04X File[%d] '%s': invalid %s hdr %s %d: %s compression unsupported"
#define HHC00310 "%1d:%04X File[%d] '%s': invalid %s hdr %s %d buf %p:%2.2x%2.2x%2.2x%2.2x%2.2x"
#define HHC00311 "%1d:%04X File[%d] '%s': shadow file name collides with %1d:%04X file[%d] '%s'"
#define HHC00312 "%1d:%04X File[%d] '%s': error re-opening readonly: '%s'"
#define HHC00313 "%1d:%04X File[%d]: no shadow file name"
#define HHC00314 "%1d:%04X File[%d] '%s':  max shadow files exceeded"
#define HHC00315 "%1d:%04X Adding shadow files..."
#define HHC00316 "Number of devices processed: %d"
#define HHC00317 "%1d:%04X Device is not a cckd device"
#define HHC00318 "%1d:%04X File[%d] '%s': error adding shadow file, sf command busy on device"
#define HHC00319 "%1d:%04X File[%d] '%s': error adding shadow file"
#define HHC00320 "%1d:%04X File[%d] '%s': shaddow file succesfully added"
#define HHC00321 "%1d:%04X Merging shadow files..."
#define HHC00322 "%1d:%04X File[%d] '%s': error merging shadow file, sf command busy on device"
#define HHC00323 "%1d:%04X File[%d] '%s': cannot remove base file"
#define HHC00324 "%1d:%04X File[%d] '%s': shadow file not merged: 'file[%d] %s%s'"
#define HHC00325 "%1d:%04X File[%d] '%s': shadow file successfully %s"
#define HHC00326 "%1d:%04X File[%d] '%s': shadow file not merged, error during merge"
#define HHC00327 "%1d:%04X File[%d] '%s': shadow file not merged, error processing trk(%d)"
#define HHC00328 "%1d:%04X Compressing shadow files..."
#define HHC00329 "%1d:%04X File[%d] '%s': error compressing shadow file, sf command busy on device"
#define HHC00330 "%1d:%04X Checking level %d..."
#define HHC00331 "%1d:%04X File[%d] '%s': shadow file check failed, sf command busy on device"
#define HHC00332 "%1d:%04X Display cckd statistics"
...
#define HHC00342 "%1d:%04X File[%d] '%s': offset 0x%" I64_FMT "x unknown space %2.2x%2.2x%2.2x%2.2x%2.2x"
#define HHC00343 "%1d:%04X File[%d] '%s': uncompress error trk %d: %2.2x%2.2x%2.2x%2.2x%2.2x"
#define HHC00344 "%1d:%04X File[%d] '%s': compression '%s' not supported"
...
#define HHC00348 "Invalid value '%d' for '%s='"
#define HHC00349 "Invalid cckd keyword: '%s'"
