...
FACILITY(LOAD_PROG_PARAM,  ZARCH,        NONE,      ZARCH,         ALS3)
#else
FACILITY(LOAD_PROG_PARAM,  NONE,         NONE,      ZARCH,         ALS3)
#endif
